...
import { projectData, sevenData } from "../data/project-data.js";
...
import sevenImage from "../data/7-Eleven-Logo.png"
      ...
      >
        <Grid item container xs={4} padding={padding}>
          <Grid item xs={12}>
            <Typography
              variant="h6"
              sx={{ fontWeight: "600", ml: matches ? "10px" : "0px" }}
            >
              7/11 Real Estate Project
            </Typography>
          </Grid>
          <Grid item xs={12}>
            <Card
          ...
          <Grid item xs={12} padding={2}>
            <Typography variant="h6">Frameworks and languages used</Typography>
            <List>
              {sevenData.framesAndLangs.map((frame, index) => {
                return (
        ...
        <Grid item container xs={8} spacing={3} padding={2}>
          <Grid item xs={12}>
            ...
            <Typography paragraph>{sevenData.role}</Typography>
          </Grid>
          <Grid item xs={12}>
            <Divider />
          </Grid>
          <Grid item xs={12}>
            ...
            <Typography paragraph>{sevenData.journey}</Typography>
          </Grid>
          <Grid item xs={12}>
            <Divider />
          </Grid>
          ...
          <Grid item xs={12}>
            ...
            <List>
              {sevenData.features.map((feature, index) => {
                return (
                  <ListItem key={index} component={Typography} paragraph>
                    <ListItemIcon>
                      <RadioButtonCheckedIcon fontSize="small" />
